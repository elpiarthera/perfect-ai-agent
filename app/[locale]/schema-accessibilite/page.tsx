...
// Authoritative locale for this slug. The EN equivalent lives at /en/accessibility-plan.
// Cross-locale access (e.g. /en/schema-accessibilite) issues a 308 redirect to the peer slug.
const AUTHORITATIVE_LOCALE = "fr";
const PEER_SLUG = "accessibility-plan";
				...
				<div className="prose-chapter text-gray-300 space-y-10">
					<section>
						<h2 className="font-serif text-2xl text-white mb-4">
							1. Mission et contexte réglementaire
						</h2>
						<p>
							...
							la citoyenneté des personnes handicapées, telle que modifiée par
							la loi n° 2016-1321 du 7 octobre 2016 pour une République
							Numérique.
						</p>
						<p className="mt-3">
							La loi impose aux services de communication publique en ligne et à
							certains organismes privés de rendre leurs contenus numériques
							accessibles. En tant que site web librement accessible, diffusant
							une œuvre à vocation culturelle et pédagogique,{" "}
							<strong className="text-white">perfectaiagent.xyz</strong>{" "}
							s&apos;engage à la conformité totale au{" "}
							<strong className="text-white">
						...
						<p className="mt-3">
							Ce schéma couvre la période{" "}
							<strong className="text-white">2026 à 2028</strong> et fait
							l&apos;objet d&apos;une révision annuelle. Il est complété par la{" "}
							<Link
					...
					<section>
						<h2 className="font-serif text-2xl text-white mb-4">
							2. Politique d&apos;accessibilité
						</h2>
						<p>
							<strong className="text-white">perfectaiagent.xyz</strong>, édité
							par ElPi Corp, s&apos;engage à rendre son site accessible à tous
							les utilisateurs, quels que soient leur handicap ou la technologie
							d&apos;assistance utilisée.
						</p>
						<p className="mt-3">
							Notre politique repose sur trois engagements&nbsp;:
						</p>
						<ul className="list-disc pl-6 mt-3 space-y-2 text-gray-400">
							<li>
								<strong className="text-white">Amélioration continue</strong> —
								les problèmes d&apos;accessibilité sont traités comme des
								anomalies, non comme des évolutions différées. Toute nouvelle
								page satisfait le RGAA 4.1.2 avant publication.
							</li>
							<li>
								<strong className="text-white">Transparence</strong> —
								l&apos;état de conformité, les résultats des audits et
								l&apos;avancement des corrections sont publiés ouvertement sur
								ce site.
							</li>
							<li>
								<strong className="text-white">Réactivité</strong> — toute
								réclamation relative à l&apos;accessibilité reçoit une réponse
								substantielle dans un délai de 5 jours ouvrés.
							</li>
						</ul>
					</section>
					...
					<section>
						...
						<p>
							Au <strong className="text-white">mars 2026</strong>,
							perfectaiagent.xyz a atteint la{" "}
							<strong className="text-accent">conformité totale</strong> au RGAA
							4.1.2.
						</p>
							...
							<dl className="space-y-2 font-sans text-sm">
								...
								<div className="flex justify-between">
									...
									<dd className="text-white">
										Pipeline d&apos;audit IA automatisé
									</dd>
								</div>
								<div className="flex justify-between">
					...
					<section>
						...
						<p>
							perfectaiagent.xyz est exploité en tant que{" "}
							<strong className="text-white">structure individuelle</strong>.
						...
						<div className="mt-4 p-4 border border-gray-700 rounded bg-gray-900 font-sans text-sm space-y-2">
							<div className="flex gap-3">
								<span className="text-muted w-52 shrink-0">
						...
						<p className="mt-4 text-sm text-gray-400">
							Le pipeline d&apos;audit effectue automatiquement des contrôles
							RGAA à chaque déploiement. Les résultats font l&apos;objet
							d&apos;une revue manuelle avant toute publication de nouvelle
							page.
						</p>
					</section>
					...
					<section>
						<h2 className="font-serif text-2xl text-white mb-4">
							5. Plan d&apos;action Année 1 — 2026
						</h2>
						<p className="text-sm text-muted mb-4">
							Objectif&nbsp;: maintenir la conformité totale au RGAA 4.1.2 sur
							...
							<tbody className="text-gray-400 divide-y divide-gray-800">
								<tr>
									<td className="py-2 pr-4">
										Re-audits RGAA 4.1.2 trimestriels sur toutes les pages
										existantes
									</td>
								...
								<tr>
									<td className="py-2 pr-4">
										Contrôle d&apos;accessibilité sur toute nouvelle page avant
										publication
									</td>
								...
								<tr>
									<td className="py-2 pr-4">
										Veille sur la publication du RGAA 5 et annonce du calendrier
										de transition
									</td>
								...
								<tr>
									<td className="py-2 pr-4">
										Mise à jour de la Déclaration d&apos;accessibilité après
										chaque audit
									</td>
								...
								<tr>
									<td className="py-2 pr-4">
										Traitement des réclamations d&apos;accessibilité sous 5
										jours ouvrés
									</td>
									<td className="py-2 pr-4">En continu</td>
									<td className="py-2 text-green-400">Actif</td>
					...
					<section>
						<h2 className="font-serif text-2xl text-white mb-4">
							6. Plan d&apos;action Année 2 — 2027
						</h2>
						<p className="text-sm text-muted mb-4">
							Objectif&nbsp;: migration vers le RGAA 5 dès publication&nbsp;;
							maintien de la couverture pour toutes les nouvelles pages.
						</p>
						<table className="w-full text-sm border-collapse">
							<thead>
								<tr className="border-b border-gray-700">
							...
							<tbody className="text-gray-400 divide-y divide-gray-800">
								<tr>
									<td className="py-2 pr-4">
										Analyse d&apos;écart RGAA 5 par rapport au site actuel
									</td>
								...
								<tr>
									<td className="py-2 pr-4">
										Migration RGAA 5 de toutes les pages existantes
									</td>
								...
								<tr>
									<td className="py-2 pr-4">
										Extension du pipeline d&apos;audit automatisé aux critères
										RGAA 5
									</td>
								...
								<tr>
									<td className="py-2 pr-4">
										Conformité RGAA 5 pour toutes les nouvelles pages
									</td>
					...
					<section>
						<h2 className="font-serif text-2xl text-white mb-4">
							7. Plan d&apos;action Année 3 — 2028
						</h2>
						<p className="text-sm text-muted mb-4">
							Objectif&nbsp;: conformité totale RGAA 5 avec validation par
						...
						<table className="w-full text-sm border-collapse">
							...
							<tbody className="text-gray-400 divide-y divide-gray-800">
								<tr>
									<td className="py-2 pr-4">
										Tests manuels avec NVDA + Chrome et VoiceOver + Safari
									</td>
								...
								<tr>
									<td className="py-2 pr-4">
										Audit RGAA 5 complet avec vérification tierce
									</td>
								...
								<tr>
									<td className="py-2 pr-4">
										Publication de la Déclaration d&apos;accessibilité mise à
										jour avec les résultats 2028
									</td>
									<td className="py-2 pr-4">T2 2028</td>
									<td className="py-2 text-muted">Planifié</td>
								</tr>
								<tr>
									<td className="py-2 pr-4">
										Publication du prochain schéma triennal (2029–2031)
									</td>
					...
					<section>
						...
						<p>
							Pour signaler un problème d&apos;accessibilité, demander un
							contenu dans un format alternatif ou poser des questions sur ce
							schéma&nbsp;:
						</p>
						<ul className="list-none mt-3 space-y-2">
							...
							<li>
								<strong className="text-white">Éditeur&nbsp;:</strong> Laurent
								Perello / ElPi Corp
							</li>
						</ul>
						<p className="mt-4">
