...
export async function generateMetadata(): Promise<Metadata> {
	return {
		...
		description:
			"Déclaration d'accessibilité de perfectaiagent.xyz — état de conformité RGAA 4.1.2 et voies de recours.",
		alternates: {
			canonical: `${SITE_URL}/fr/accessibilite`,
			languages: {
		...
		openGraph: {
			...
			title: "Déclaration d'accessibilité",
			description:
				"Déclaration d'accessibilité de perfectaiagent.xyz — état de conformité RGAA 4.1.2.",
			url: `${SITE_URL}/fr/accessibilite`,
			images: [
				{
			...
			<article className="max-w-3xl mx-auto px-6 pt-16 pb-24">
				<header className="mb-12">
					...
					<p className="text-muted font-sans">
						Publiée le 18 mars 2026 — Mise à jour le 18 mars 2026
					</p>
				</header>
				...
				<div className="prose-chapter text-gray-300 space-y-8">
					<section>
						...
						<p>
							...
							par ElPi Corp, est{" "}
							<strong className="text-white">partiellement conforme</strong>{" "}
							avec le Référentiel Général d&apos;Amélioration de
							l&apos;Accessibilité (RGAA) 4.1.2.
						</p>
						<p className="mt-3">
							Taux de conformité&nbsp;:{" "}
							<strong className="text-accent">58 %</strong> (31 critères
							conformes sur 53 applicables).
						</p>
					</section>
					...
					<section>
						<h2 className="font-serif text-2xl text-white mb-4">
							Pages ayant fait l&apos;objet de la vérification
						</h2>
						<ol className="list-decimal pl-6 space-y-1 text-gray-400">
							<li>
								Page d&apos;accueil — <code>/en</code> et <code>/fr</code>
							</li>
							<li>
								Index des chapitres — <code>/en/chapters</code>
							</li>
							<li>
								Page de chapitre — <code>/en/chapters/prologue</code> et{" "}
								<code>/fr/chapters/prologue</code>
							</li>
							<li>
								Politique de confidentialité — <code>/en/privacy</code>
							</li>
						</ol>
					</section>
						...
						<ol className="list-decimal pl-6 mt-3 space-y-2 text-gray-400">
							<li>
								<strong className="text-white">
									Champ email sans label accessible
								</strong>{" "}
								(Critère 11.1, 11.2) — Le champ email de la newsletter ne
								disposait pas d&apos;association programmatique à un label.{" "}
							...
							<li>
								...
								(Critère 12.7) — Aucun mécanisme permettant aux utilisateurs
								clavier de sauter la navigation.{" "}
								<span className="text-accent">Corrigé le 18 mars 2026.</span>
							</li>
							<li>
								<strong className="text-white">
									Contraste insuffisant sur les textes secondaires
								</strong>{" "}
								(Critère 3.2) — Certains textes de sous-titres et légendes
								utilisaient des couleurs avec un ratio de contraste inférieur au
								seuil AA (4,5:1).
							</li>
							<li>
								<strong className="text-white">
								...
								(Critère 9.1) — Sur la page d&apos;accueil, des éléments h2
								apparaissaient avant le h1. Sur l&apos;index des chapitres, la
								hiérarchie sautait le niveau h2.
							</li>
							<li>
								<strong className="text-white">
									Titre de page non traduit sur les pages françaises
								</strong>{" "}
								(Critère 8.6) — L&apos;élément &lt;title&gt; restait en anglais
								sur les pages en langue française.
							</li>
							<li>
								<strong className="text-white">
									Rendu serveur partiel sur les pages de chapitres
								</strong>{" "}
								(Critère 8.3) — Les pages de chapitres retournaient un shell
								HTML sans attribut <code>lang</code> avant l&apos;hydratation
					...
					<section>
						...
						<p className="mt-1">
							<strong className="text-white">Responsable du site&nbsp;:</strong>{" "}
					...
					<section>
						...
						<p>
							Si vous signalez un défaut d&apos;accessibilité et ne recevez pas
							de réponse satisfaisante dans un délai raisonnable, vous pouvez
						...
						<ul className="list-disc pl-6 mt-3 space-y-2 text-gray-400">
							...
							<li>
								Par courrier postal (gratuit, sans timbre)&nbsp;:
								<br />
