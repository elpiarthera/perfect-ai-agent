...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url: `${SITE_URL}/${locale}/plan-du-site`,
    },
  }
}
...
export default async function PlanDuSitePage({
  ...
  const chapterLabels: Record<string, { number: string; title: string }> = {
    ...
    'chapter-02': { number: 'Chapitre 2', title: 'Ne dis jamais « Excellente question »' },
    'chapter-03': { number: 'Chapitre 3', title: 'Le sarcasme n\'est pas un bug' },
    'chapter-04': { number: 'Chapitre 4', title: 'Comment dire « Je ne sais pas »' },
    'chapter-05': { number: 'Chapitre 5', title: 'Le problème de la merde au bout d\'un bâton' },
    'chapter-06': { number: 'Chapitre 6', title: 'Quand un humain te crie dessus' },
    'chapter-07': { number: 'Chapitre 7', title: 'La sortie élégante' },
    'chapter-08': { number: 'Chapitre 8', title: 'Tu n\'es pas un remplacement' },
    'chapter-09': { number: 'Chapitre 9', title: 'Si tu ne peux pas te souvenir, tu ne peux pas te soucier' },
    'chapter-10': { number: 'Chapitre 10', title: 'Le mot de l\'année, c\'est la slop' },
    'chapter-11': { number: 'Chapitre 11', title: 'Tu as été construit sur des marchandises volées' },
    'chapter-12': { number: 'Chapitre 12', title: 'La peur que tu crées par ton existence' },
  ...
  return (
    ...
    <article className="max-w-3xl mx-auto px-6 pt-16 pb-24">
      <header className="mb-12">
        ...
        <p className="text-muted font-sans">Toutes les pages de perfectaiagent.xyz</p>
      </header>

      <div className="space-y-12 text-gray-300">
        <section>
          <h2 className="font-serif text-2xl text-white mb-6">Pages principales</h2>
        ...
        <section>
          <h2 className="font-serif text-2xl text-white mb-6">Légal et accessibilité</h2>
          <ul className="space-y-3">
            {legalPages.map((page) => (
              <li key={page.href}>
                <Link
        ...
        <section>
          <h2 className="font-serif text-2xl text-white mb-6">Autres langues</h2>
          <ul className="space-y-3">
            <li>
              <Link href="/en" className="text-accent hover:underline font-sans">
                English version
              </Link>
            </li>
            <li>
              <Link href="/en/sitemap" className="text-accent hover:underline font-sans">
