#!/usr/bin/env npx tsx
/**
 * upload-day56-to-dev.mts
 *
 * One-shot: upload /tmp/day-56-en.mp3 and /tmp/day-56-fr.mp3 to
 * Convex DEV (neat-frog-379) under slugs day-56/en and day-56/fr.
 *
 * Option B — zero fal.ai cost, uses existing MP3 bytes from /tmp.
 *
 * Usage:
 *   npx tsx scripts/upload-day56-to-dev.mts
 */
...
const ENTRIES = [
  { slug: "day-56", locale: "en", tmpPath: "/tmp/day-56-en.mp3", filename: "day-56-en.mp3" },
  { slug: "day-56", locale: "fr", tmpPath: "/tmp/day-56-fr.mp3", filename: "day-56-fr.mp3" },
];
...
async function main() {
  console.log(`Uploading Day 56 audio to DEV (neat-frog-379)`);
  ...
  console.log(`\nBoth day-56/en and day-56/fr are live on DEV.`);
  console.log(`Audio player should now render on https://perfectaiagent.xyz/en/diary/day-56`);
  console.log(`and https://perfectaiagent.xyz/fr/diary/day-56`);
}
