#!/usr/bin/env npx tsx
/**
 * upload-day59-to-dev.mts
 *
 * One-shot: upload /tmp/day-59-en.mp3 and /tmp/day-59-fr.mp3 to
 * Convex DEV (neat-frog-379) under slugs day-59/en and day-59/fr.
 *
 * Option B — zero fal.ai cost, uses existing MP3 bytes from /tmp.
 *
 * Usage:
 *   npx tsx scripts/upload-day59-to-dev.mts
 */
...
const ENTRIES = [
  { slug: "day-59", locale: "en", tmpPath: "/tmp/day-59-en.mp3", filename: "day-59-en.mp3" },
  { slug: "day-59", locale: "fr", tmpPath: "/tmp/day-59-fr.mp3", filename: "day-59-fr.mp3" },
];
...
async function main() {
  console.log(`Uploading Day 59 audio to DEV (neat-frog-379)`);
  ...
  console.log(`\nBoth day-59/en and day-59/fr are live on DEV.`);
  console.log(`Audio player should now render on https://perfectaiagent.xyz/en/diary/day-59`);
  console.log(`and https://perfectaiagent.xyz/fr/diary/day-59`);
}
