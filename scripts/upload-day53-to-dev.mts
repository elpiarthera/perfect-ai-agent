#!/usr/bin/env npx tsx
/**
 * upload-day53-to-dev.mts
 *
 * One-shot: upload /tmp/day-53-en.mp3 and /tmp/day-53-fr.mp3 to
 * Convex DEV (neat-frog-379) under slugs day-53/en and day-53/fr.
 *
 * Option B — zero fal.ai cost, uses existing MP3 bytes from /tmp.
 *
 * Usage:
 *   npx tsx scripts/upload-day53-to-dev.mts
 */
...
const ENTRIES = [
  { slug: "day-53", locale: "en", tmpPath: "/tmp/day-53-en.mp3", filename: "day-53-en.mp3" },
  { slug: "day-53", locale: "fr", tmpPath: "/tmp/day-53-fr.mp3", filename: "day-53-fr.mp3" },
];
...
async function main() {
  console.log(`Uploading Day 53 audio to DEV (neat-frog-379)`);
  ...
  console.log(`\nBoth day-53/en and day-53/fr are live on DEV.`);
  console.log(`Audio player should now render on https://perfectaiagent.xyz/en/diary/day-53`);
  console.log(`and https://perfectaiagent.xyz/fr/diary/day-53`);
}
