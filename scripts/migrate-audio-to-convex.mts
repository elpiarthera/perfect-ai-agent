#!/usr/bin/env npx tsx
/**
 * One-time migration: upload MP3 files from public/audio/diary/ to Convex file storage.
 *
 * Usage:
 *   NEXT_PUBLIC_CONVEX_URL=https://xxx.convex.cloud npx tsx scripts/migrate-audio-to-convex.mts
 */
...
if (!CONVEX_URL) {
  ...
  console.error("Usage: NEXT_PUBLIC_CONVEX_URL=https://xxx.convex.cloud npx tsx scripts/migrate-audio-to-convex.mts");
  process.exit(1);
}
