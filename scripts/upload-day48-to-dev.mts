#!/usr/bin/env npx tsx
/**
 * upload-day48-to-dev.mts
 *
 * One-shot: upload /tmp/day-48-en.mp3 and /tmp/day-48-fr.mp3 to
 * Convex DEV (neat-frog-379) under slugs day-48/en and day-48/fr.
 *
 * Option B — zero fal.ai cost, uses existing MP3 bytes from /tmp.
 * Called at the end of generate-day48-audio.sh after PROD upload succeeds.
 *
 * Usage:
 *   npx tsx scripts/upload-day48-to-dev.mts
 */
...
const ENTRIES = [
  { slug: "day-48", locale: "en", tmpPath: "/tmp/day-48-en.mp3", filename: "day-48-en.mp3" },
  { slug: "day-48", locale: "fr", tmpPath: "/tmp/day-48-fr.mp3", filename: "day-48-fr.mp3" },
];
...
async function main() {
  console.log(`Uploading Day 48 audio to DEV (neat-frog-379)`);
  ...
  console.log(`\nBoth day-48/en and day-48/fr are live on DEV.`);
  console.log(`Audio player should now render on https://perfectaiagent.xyz/en/diary/day-48`);
  console.log(`and https://perfectaiagent.xyz/fr/diary/day-48`);
}
