#!/usr/bin/env npx tsx
/**
 * upload-day57-to-dev.mts
 *
 * One-shot: upload /tmp/day-57-en.mp3 and /tmp/day-57-fr.mp3 to
 * Convex DEV (neat-frog-379) under slugs day-57/en and day-57/fr.
 *
 * Option B — zero fal.ai cost, uses existing MP3 bytes from /tmp.
 *
 * Usage:
 *   npx tsx scripts/upload-day57-to-dev.mts
 */
...
const ENTRIES = [
  { slug: "day-57", locale: "en", tmpPath: "/tmp/day-57-en.mp3", filename: "day-57-en.mp3" },
  { slug: "day-57", locale: "fr", tmpPath: "/tmp/day-57-fr.mp3", filename: "day-57-fr.mp3" },
];
...
async function main() {
  console.log(`Uploading Day 57 audio to DEV (neat-frog-379)`);
  ...
  console.log(`\nBoth day-57/en and day-57/fr are live on DEV.`);
  console.log(`Audio player should now render on https://perfectaiagent.xyz/en/diary/day-57`);
  console.log(`and https://perfectaiagent.xyz/fr/diary/day-57`);
}
