#!/usr/bin/env npx tsx
/**
 * upload-day49-to-dev.mts
 *
 * One-shot: upload /tmp/day-49-en.mp3 and /tmp/day-49-fr.mp3 to
 * Convex DEV (neat-frog-379) under slugs day-49/en and day-49/fr.
 *
...
const ENTRIES = [
  { slug: "day-49", locale: "en", tmpPath: "/tmp/day-49-en.mp3", filename: "day-49-en.mp3" },
  { slug: "day-49", locale: "fr", tmpPath: "/tmp/day-49-fr.mp3", filename: "day-49-fr.mp3" },
];
...
async function main() {
  console.log(`Uploading Day 49 audio to DEV (neat-frog-379)`);
  ...
  console.log(`\nBoth day-49/en and day-49/fr are live on DEV.`);
  console.log(`Audio player should now render on https://perfectaiagent.xyz/en/diary/day-49`);
  console.log(`and https://perfectaiagent.xyz/fr/diary/day-49`);
}
