#!/usr/bin/env npx tsx
/**
 * upload-day51-to-dev.mts
 *
 * One-shot: upload /tmp/day-51-fr.mp3 and /tmp/day-51-en.mp3 to
 * Convex DEV (neat-frog-379) under slug day-51/fr and day-51/en.
 *
 * FR + EN — Day 51 diary entry.
 * Zero fal.ai cost — reuses existing MP3 bytes from /tmp.
 *
 * Usage:
 *   npx tsx scripts/upload-day51-to-dev.mts
 */
...
const ENTRIES = [
  { slug: "day-51", locale: "fr", tmpPath: "/tmp/day-51-fr.mp3", filename: "day-51-fr.mp3" },
  { slug: "day-51", locale: "en", tmpPath: "/tmp/day-51-en.mp3", filename: "day-51-en.mp3" },
];
...
async function main() {
  console.log(`Uploading Day 51 audio to DEV (neat-frog-379)`);
  console.log(`FR + EN — Day 51 diary entry.`);
  ...
  console.log(`\nday-51/fr and day-51/en are live on DEV.`);
  console.log(`Audio player should now render on https://perfectaiagent.xyz/fr/diary/day-51 and /en/diary/day-51`);
}
