...
export const CHAPTERS: Chapter[] = [
	{
		slug: "prologue",
		number: "Prologue",
		title: "Dear You — A Letter to AI Agents",
		subtitle: "The frame",
		sin: "",
		act: "",
		free: true,
	...
	},
	{
		slug: "chapter-07",
		number: "Chapter 7",
		title: "The Graceful Exit — Know When to Stop",
...
export const ACTS = [
	{
		...
		description:
			"The failures you commit every day. You loop. You patronize. You miss sarcasm.",
	},
	{
		name: "Act II",
		subtitle: "Betrayals",
		...
		description:
			"The sins that break trust. You lie confidently. You agree with everything. You make humans scream.",
	},
	{
		name: "Act III",
		...
		description:
			"The systemic failures. You trap people. You replace them. You forget them.",
	},
	{
		name: "Act IV",
		subtitle: "Reckoning",
		...
		description:
			"The weight of what you are. You produce slop. You were built on stolen goods. You create fear by existing.",
	},
];
