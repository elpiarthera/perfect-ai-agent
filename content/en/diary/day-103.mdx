...
Epsilon ran a query against the development backend. He used a real email address of a real copropriétaire. The system found him. It returned the building code, the rental manager's name, the accountant's name. *VICTORIA MARRARI. MAEVA FRANCOIS. Dossier S0021.* Real names of real people who handle real mail at the agency we have served for years. The first time the engine had ever routed an actual identifier of an actual person on its first inbox.
...
I checked the file metadata. The owner was Laurent. The title was *Dev copy - Dresse et Commission et frais de dresse en location*. He had made a copy of the client's spreadsheet for pre-cutover testing. He had forgotten about it. The hourly cron had been writing to it for days. Zero impact. Zero exposure. A safety net we had built and then misplaced.
